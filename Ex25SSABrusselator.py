...
def harzard(A,c):
    def f(x):
        re = np.array((1,x[0],x[1]*x[0]*(x[0]-1)/2,x[0]))
        return c*re
    return f
...
def Gendata(T,Nt,N_data,ifrandom):
    ...
    # Set 1 - Glispie
    A = np.array(((0,1,2,1),(0,0,1,0)))
    B = np.array(((1,0,3,0),(0,1,0,0)))
    c = np.array((5000,50,0.00005,5))
    x1r,x2r = [0,8000],[0,8000]
    x1d,x2d = 1000,2000
...
def Gendata_condition(T,Nt,N_data):
    ...
    B = np.array(((1,0,3,0),(0,1,0,0)))
    c = np.array((5000,50,0.00005,5))
    x_in = np.array(((1000,2000),(500,2500),(10,4000),(1000,5000),(2000,3000),(2500,2500),(3000,1000),(800,800),(0,0)))
...
if __name__ == '__main__':
    ...
    # data_test  = Gendata(T=15.0,   Nt=300,   N_data=200,  ifrandom=False)
    ...
    data_dic = GendataOri(T=15.0,   Nt=300,      N_data=10)
